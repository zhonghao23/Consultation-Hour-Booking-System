...
public class ViewBookedCH extends javax.swing.JFrame {
    ...
    public ViewBookedCH(StudentPage a, ArrayList<ConsultationHour> b, Student c){
        initComponents();
        student_page = a;
        CHprofile = b;
        loggedinUser = c;
        String [][]data = loggedinUser.viewBookedCHprofile();
    ...
    private void initComponents() {
        ...
        buttonCancelCH = new javax.swing.JButton();
        ...
        jLabelLecturerProf.setText("Booked Consultation Hours");

        buttonCancelCH.setBackground(new java.awt.Color(255, 204, 102));
        buttonCancelCH.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        buttonCancelCH.setText("CANCEL");
        buttonCancelCH.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonCancelCHActionPerformed(evt);
            }
        });
        ...
        jPanelCHLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelCHLayout.createSequentialGroup()
                ...
                .addGroup(jPanelCHLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(buttonCancelCH, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanelCHLayout.setVerticalGroup(
            ...
            .addGroup(jPanelCHLayout.createSequentialGroup()
                ...
                .addGap(40, 40, 40)
                .addComponent(buttonCancelCH, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jPanelCH, javax.swing.GroupLayout.DEFAULT_SIZE, 892, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void buttonCancelCHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCancelCHActionPerformed
        ...
        if(loggedinUser.cancelCH(lect_name, date, time, CHprofile, loggedinUser) == true){
            this.dispose();
            ViewBookedCH view_Booked_CH = new ViewBookedCH(student_page,CHprofile,loggedinUser);
            view_Booked_CH.setVisible(true);
        }
    }//GEN-LAST:event_buttonCancelCHActionPerformed
    ...
    private javax.swing.JButton buttonCancelCH;
